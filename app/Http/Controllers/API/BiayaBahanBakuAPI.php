...
class BiayaBahanBakuAPI extends Controller
{
    public function create($produksi_id, Request $request)
    {
        ...
        $data = BiayaBahanBaku::create($input);
    ...
    {
        $result = BiayaBahanBaku::where('id', '=', $id)->first();
        if (isset($result->id)) {
            return response()->json([
                'error' => false,
                'message' => 'success',
    ...
    public function update(Request $request, $id)
    {
        ...
        $cari = BiayaBahanBaku::where('id', '=', $id);
    ...
    {
        $result = BiayaBahanBaku::where('id', '=', $id);
        if($result->delete()){
            return response()->json([
                'error' => false,
                'message' => 'success'
